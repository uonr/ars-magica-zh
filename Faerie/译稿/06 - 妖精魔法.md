...
有些妖精巫师能够以类似赫尔墨斯魔法所用即兴法术的方式，产生超自然效果。他们与妖精域的感通，以及对某些可汲取这种感通的超自然技法的了解，使他们能将自己的力量凝聚到这些法术上；这些法术称为仪式。
...
每种妖精力量都易受某些不常见情境影响，例如接触铁、流水或盐，身处神圣统御区，或角色的名字被重复三次。每当这种条件应用于目标时，它会解除目标身上与该力量相关的所有效果；若该条件应用于施法者，则会解除施法者维持的该力量相关效果。角色每获得一项新力量时，都必须选择它的特定弱点。
...
目标群体被变成最符合他们表层想法的动物。此效果持续到他们向附魔师道歉并为引发此法术的侮辱作出补偿，或者直到他们或施法者死亡为止。
...
梦境是一种看入神话欧洲之外妖精国度的力量，使做梦者能作为置身于妖精扮演其戏角的传奇故事之外的公正观察者。在这里，做梦者可以从身体之外看到周围的世界，并且能够通过梦境的通用语言理解他人的思想和话语。甚至可以通过梦境瞥见未来的一种可能，尽管获得的信息是基于妖精故事通常如何发展，并倾向于表现为模糊的迹象和预兆——即将到来的好事或坏事的象征。妖精幻象可能会引人误解，一些妖精巫师相信，由于做梦者深信自己的解释，实际上正是这些幻象导致了他想象中的事情发生。
...
>
> **通用：** 在持续时间内，将目标视为拥有预感 (Premonitions) 技能，得分为（此效果的基准等级 / 5）。
> 
...
>
> **等级 4：** 允许施法者回答一个关于目标下一分钟内可能命运的问题。
>
> 允许目标用施法者的母语说话。
> 
...
> surface thoughts.
>
> **等级 5：** 允许施法者回答一个关于目标下一小时内可能命运的问题。
>
> 允许施法者阅读目标的表面思想。
> 
...
>
> **等级 10：** 允许施法者回答一个关于目标接下来一天内可能命运的问题。
>
> 允许施法者阅读目标过去一天的记忆。
> 
...
在施行此仪式之后，任何人都可以看向水池，并感知另一个地点正在发生的事件，该地点由施法者在施法时描述。如果看向水池的人与另一个地方有强烈的妖精感通，他往往可以改变这个地点。
...
赋赐给予施法者以妖精的超自然力量祝福（或诅咒）目标的力量。这最常以扭曲点数或临时优势与劣势的形式显现。由于大部分这些力量只在效果持续期间存在，它们通常被作为仪式施展，并持留到某个特定条件被满足为止。从此力量获得的所有劣势，要么是超自然（妖精），要么是通用劣势；而所有的优势都是符印优势 (Charmed Virtues)；详情请见第五章：妖精之触，符印。
...
一些赋赐效果会以感通特征的形式赋予目标妖精感通。注意，就像通过感通感化获得的感通特征一样，这些特征是暂时的、不能提升，且不影响角色的妖精等级（见第五章：妖精之触，感通感化）。
...
### 妖精茧手之触 (Know Then the Calloused Touch of Faerie Hands)
...
**解缚魅仆 (Release the Spellbound Servant)** 移情/庇护 通用 距程：接触，持续：一时+一，目标：个体，仪式
...
**主权御敌之寂 (Sovereign Silence of Opposition)** 唤灵/庇护 通用
...
> 
> **通用：** 给予目标在痊愈检定上的加值以及老化检定上的惩罚，或者老化检定的加值以及痊愈检定的惩罚，其数值等于（(3 + 量级) x 3）；前提是此效果在至少一半的时期内保持激活。这种痊愈惩罚不会导致创伤恶化，尽管它确实会阻止创伤正常痊愈。
> 
...
> 
> **等级 1：** 在痊愈检定上给予目标 +1 加值，在老化检定上给予 +1 惩罚，或者在老化检定上给予 –1 加值，在痊愈检定上给予 –1 惩罚。
> 
...
> 
> **等级 2：** 在痊愈检定上给予目标 +3 加值，在老化检定上给予 +3 惩罚，或者在老化检定上给予 –3 加值，在痊愈检定上给予 –3 惩罚。
> 
...
> 
> **等级 3：** 在痊愈检定上给予目标 +6 加值，在老化检定上给予 +6 惩罚，或者在老化检定上给予 –6 加值，在痊愈检定上给予 –6 惩罚。
> 
...
> 
> **等级 4：** 在痊愈检定上给予目标 +9 加值，在老化检定上给予 +9 惩罚，或者在老化检定上给予 –9 加值，在痊愈检定上给予 –9 惩罚。
> 
...
> 
> 在持续期间内，使单个创伤自然痊愈的间隔缩短一个阶段。例如，重伤将作为中伤痊愈，中伤作为轻伤痊愈。对于轻伤或失能创伤，目标可以立即进行一次痊愈检定，且不可能发生恶化。（仪式）
> 
> **Level 20:** Heal an Incapacitating wound for the duration.
> 
> **等级 20：** 在持续期间内治愈一个失能创伤。
> 
...
**无尽之夏 (The Endless Summer)** 移情/安康 通用 距程：接触，持续：年+1，目标：个体，仪式
...
在效果持续期间，目标在老化检定上获得等于（3 x (该效果的量级 – 2)）的修正（即从老化检定结果中减去该数值）。例如，一个25级效果会使老化检定减去9。这也会对该期间内进行的痊愈检定产生相同数额的负面影响。在进行检定之前，该效果必须在至少一半的期间内保持激活状态，因此该仪式最迟必须在夏季举行，才能影响角色当年的老化检定。
...
目标（必须处于失能状态或受过轻伤）可以立即进行一次痊愈检定。如果结果为负面，将其视为没有变化。
...
妖精仪式允许妖精巫师像他们引导其力量的妖精一样，直接伤害目标。因此，灾厄比赫尔墨斯魔法更容易造成严重伤害。然而，由于妖精仪式的普遍特性，一旦效果消退，这种伤害就会立刻消失。因此，运用这种力量的人通常会用仪式骚扰和迷惑猎物，而不是简单地摧毁他们。当然，一旦敌人失去判断，直接砍下他们的头通常要容易得多。
...
这个仪式施展在某种武器上——通常是箭头或刀子——并以被它击中的人为目标。在效果持续期间，目标的其中一个创伤（可能就是由该武器造成的那个）会按照失能创伤的规则痊愈。这意味着目标必须在日出和日落时进行痊愈检定，并伴随着死亡或状况恶化的正常风险，但他实际上并没有失能。一旦直接危险过去，该创伤将保持为重伤，直到仪式的持续时间结束；此时，它会恢复到先前的创伤等级。
...
**无情情人之触 (Touch of the Merciless Lover)** 移情/灾厄 25
...
**苍年凝视 (Gaze of Gray Years)** 附魔/灾厄 30 距程：目光，持续：持留，目标：个体
...
施法者执行一个具有冷酷且令人毛骨悚然意义的动作，然后集中精神，直到他能直视目标的眼睛来释放效果。该目标必须年满 35 岁，并且必须立即进行一次老化掷骰。作为一个额外效果，此仪式包含一个诅咒，使目标在该掷骰上承受 +15 惩罚。这通常足以导致目标获得一点衰朽点并遭遇老化危机；而且由于这是老化的自然后果，所以当持续时间结束时，这些效果不会被撤销。

(Base 15, +1 Eye, +1 Held, +1 additional effect)

（基准 15，+1 目光，+1 持留，+1 额外效果）
...
>
> 将单一创伤自然痊愈的间隔在持续时间内增加一个阶段。例如，轻伤按中伤痊愈，中伤按重伤痊愈，重伤按失能创伤痊愈。失能创伤不会痊愈——如果效果持续时间超过痊愈时间的一半，目标将直接死亡。
> 
> **Level 2:** Give the target a –3 penalty to Recovery rolls or a +3 penalty to Aging rolls.
>
> **等级 2：** 给目标的痊愈掷骰带来 –3 减值，或给老化掷骰带来 +3 惩罚。
> 
...
>
> **等级 4：** 给目标的痊愈掷骰带来 –9 减值，或给老化掷骰带来 +9 惩罚。
> 
...
与议约相关的力量有四种：召唤 (Summoning)、连结 (Bonding)、迷魅 (Captivating) 与遣散 (Dismissing)。这些力量中的每一种都可以作为超自然技能学习（见第五章：妖精之触，学习妖精技能），或从优势中获得（见第五章：妖精之触，新增与修改的优势）。一旦获得，这些力量的初始得分为 0，并像秘艺一样提升，尽管它们可以像超自然技能一样被实践和学习。
...
还有几种其他的召唤技艺（见“召唤妖精”侧栏），但这种召唤几乎总是与妖精域相连。可能存在与其他界域相连的此类召唤力量的其他版本，同样用于促进与秘法、下界或神圣生物而非妖精的议约，但其他三种议约技艺（连结、迷魅与遣散）则完全是妖精力量。
...
召唤是一种从周边地区唤出妖精并让它们待命，以便与其进行议约的神秘秘艺。对一些人来说，这种秘艺似乎实际上创造了一个妖精，或者将一个凡俗物品变成了一个妖精；但大多数召唤者相信，妖精来自附近的某个地方，并以适当的形状显现。而且，既然可以召唤那些已经承担了特定戏角的妖精，大多数召唤者也相信那些显现的其他妖精在召唤之前也一定存在。
...
要召唤一个妖精，召唤者必须拥有一项适当的正向或负向感通特征，以代表与该类型妖精的联系。如果召唤者有几项适用的感通特征，则将它们的得分相加；如果数值为负，则视为正数。这些特征的总和乘以 5，决定了该角色可以召唤的最高威能值。召唤者的妖精等级也会提升或降低他的召唤总值。
...
然后，召唤者必须在精神上准备几分钟，并消耗一个疲劳等级（如果他无法消耗疲劳，就无法进行召唤）。玩家决定他将尝试召唤的妖精的强度，该强度不能超过由其适用感通特征决定的最高威能值，并进行一次掷骰：压力骰 + 仪态 + 召唤 + 他的妖精等级 + 辉环修正。
...
>
> 在神话欧洲，至少还有另外三种可以用来召唤妖精的超自然技能，而且既然它们都源自基督诞生很久以前巫士所修习的同一种秘艺，它们使用了非常相似的概念。它们之间的差异主要在于它们如何以妖精和其他超自然存在为目标，如下文所述。为了帮助区分它们，每个版本的“召唤”前面可能都会带有一个括号，以暗示其侧重点。例如，来自奇幻技艺 (Ars Fabulosa) 的妖精召唤可能被称为“（妖精）召唤”，因为它只影响其特定界域的存在。
> 
...
>
> **（精魂）召唤 ((Spirit) Summoning)：** 这门秘艺将一个无形精魂召唤到召唤者身边，通常是与赋予召唤者此项力量的威能界域相关的精魂，不过恶魔也特别有可能出现。如果召唤成功，精魂会被束缚在一个圆阵中，直到被召唤者释放。精魂召唤总是受到下界域影响的污染，因此下界域版本最为常见，但它也可能与妖精域或秘法域相关。相关的秘艺（剥蚀 (Ablating)、束缚 (Binding) 和统御 (Commanding)）全都是下界属性。（《威能界域：地狱》，第 114-115 页。）
> 
...
>
> **（元素）召唤 ((Elemental) Summoning)：** 这种类型树篱魔法的某些应用会召唤一个与特定元素（水 (Aquam)、风 (Auram)、火 (Ignem) 或地 (Terram)）相关的元素存在。这种存在可以来自任何界域，包括妖精域，并且通常被关在一个容器中，在那里它会一直受到召唤者的控制直到被释放。这种力量最常是秘法属性的，尽管与其他界域相关的版本也是有可能的。相关的元素使秘艺（操控 (Controlling)、占卜 (Divining) 与提纯 (Refining)）总是与秘法属性相连。（《树篱魔法》 (Hedge Magic)，第 2 章：元素使，召唤）
> 
...
无论召唤总值是多少，即使掷出大失败，也会有一只妖精出现。如果附近有一件与召唤中使用的感通特征相关的凡俗物品，妖精可能会通过活化那件物品来出现，或者它可能只是简单地从周围环境的某个地方钻出来，比如从树后或地里出来。如果玩家真的掷出大失败，妖精将会对召唤者抱有敌意，或者可能不受他们达成的任何议约条款的约束。又或者召唤者可能会错误地召唤出天使或恶魔，或者召唤出的妖精看起来像另一只妖精，抑或是比召唤者预期的要更强大或更弱小。
...
召唤者可以根据妖精的戏角，尝试召唤某只特定的妖精；不过，除非他拥有与其相连的奥法连接，否则无法保证得到的妖精就是他想要的那一只。该效果会召唤出一只威能值不大于最高值、且具备召唤中使用的所有感通特征性质的妖精。如果该描述适用于该区域内不止一只妖精，则由指引者决定哪一只出现。如果召唤者确实拥有某个特定妖精的奥法连接，他必须穿透其魔法抗力，才能确保它会出现；并请注意，如果玩家拥有适用的感通特征，他可以将最高的适用感通特征加到自己的穿透合计中。否则，成为目标的妖精可能会收到召唤却干脆忽略它。
...
如果召唤总值等于或超过被召唤妖精的威能值，并且该效果穿透了它的魔法抗力，召唤者就能在持续期间内约束这只妖精。当妖精以这种方式被约束时，召唤者使用其他议约秘艺来穿透其魔法抗力就会容易得多。此外，在召唤结束之前，它必须留在他身边并听取他要说的话，并且召唤者受到结界保护，免受它试图对他使用的任何攻击或力量影响。然而，召唤者或妖精都可以在任何时候结束召唤，这会立即将妖精送回它来的地方。妖精可能会选择留下来听听召唤者要说什么；如果它不在乎当前情境，也可能干脆直接离开。大多数妖精都会耐心听到召唤者开出条件。
...
如果召唤总值低于被定为目标的妖精的威能值，或者该效果未能穿透其魔法抗力，那么出现的妖精完全不会受到召唤束缚。它可以随心所欲地忽略召唤者、攻击他或用其力量影响他。妖精可以随意返回它来的地方，但召唤者无法将它遣散。
...
一旦召唤结束，如果双方能够达成一项安排，召唤者将在一项适当的感通特征上获得一点经验值。如果他们没有达成议约，他就会从一项适当的感通特征中减去一点经验值。这意味着角色用缺乏诚意的提议去骚扰妖精通常得不偿失。双方达成的任何议约对妖精都具有约束力，并且它不能通过作为或不作为来打破这项协议，即使召唤者没有履行自己那部分安排。召唤者如果在召唤期间打破了议约的条款，就会立即获得一项适合该妖精的 –3 感通特征。这意味着召唤者违约很少值得，因为这会导致他失去妖精感通，并可能同时失去妖精等级。
...
连结总值必须超过妖精的威能才能成功，且必须穿透它的魔法抗力（不过和通常一样，召唤者可以将他最高适用的感通特征加入他的穿透得分）。如果该妖精被一个成功的召唤（已穿透其魔法抗力的召唤）所持留，在计算穿透合计时将效果等级视为 0，否则效果等级等于妖精的威能值。例如，要与一个妖精威能 15 的妖精连结，召唤者需要 30 的连结总值 + 穿透加值，或者如果该妖精被成功的召唤效果持留，则只需 15。
...
如果连结绑定在一个物品而非人身上，该物品需要一个符印（见第五章：妖精之触，符印）；这个符印必须每天启动，持有者才能获得效果。此符印在连结形成时创造，且必须由召唤者教给持有者。如果符印的秘密被打破，连结就会被解开，议约也就此结束。如果物品被摧毁，连结也会结束。
...
>
> 如果经过一段时间后（比方说几分钟后）玩家仍无法达成协议，你可以用沟通 + 议约 (Bargain) 的对抗检定快速解决议约环节，并以角色的妖精等级作修正。注意，适用的感通特征也可以作为此技能的专长来应用。
> 
...
>
> 召唤者在旅行时通常会携带啤酒、牛奶、宝石或其他富含元气的物品，以便在议约中提供；仔细选择感通特征可以让这类物品更有可能被接受。他们可能对妖精提出的典型要求包括：服务，例如和召唤者一起对抗敌人、用其力量祝福召唤者，或者允许召唤者用他的其他议约力量影响它；许可，例如穿过妖精拥有的土地，或从中收获源质及其他资源；与召唤者及其社区或旅行同伴签订互不侵犯条约；或者承诺欠召唤者一个人情，在下次被召唤时前来提供帮助。大多数妖精会试图避免长期承诺，因为这会限制它们获得元气的能力。然而，无认知或狭隘认知的妖精可能会接受完全契合自身的长期承诺。尽管如此，它们仍然期望从召唤者那里获得实质性的补偿。
...
迷魅是一门与妖精互换位置的技艺——在持续期间，妖精获得召唤者身体的控制权，而召唤者则成为该妖精。召唤者只能影响处于其声音距程内的妖精，且该妖精的妖精威能不能大于召唤者适用感通特征绝对值总和乘以 5。启动该效果需要消耗召唤者一个疲劳等级。

**Captivating Total: stress die + Perception + Captivating + Faerie Rank + aura**

**迷魅总值：压力骰 + 感知 + 迷魅 + 妖精等级 + 辉环**
...
迷魅总值必须超过妖精的威能才能成功，并且必须穿透其魔法抗力（不过像往常一样，召唤者可以将其最高适用的感通特征加到其穿透得分上）。如果妖精正被一个成功的召唤（即穿透了其魔法抗力的召唤）所持留，在计算穿透合计时将效果等级视为 0，否则效果等级为妖精的威能值。例如，要与一个妖精威能为 20 的妖精互换位置，召唤者需要 40 的迷魅总值加穿透加值，或者如果妖精被一个成功的召唤持留，则只需 20。
...
如果效果成功穿透，召唤者与妖精立即互换位置。也许实现这一点的最简单方法是让玩家们交换角色卡。召唤者可以随心所欲地控制妖精的身体，而妖精也对召唤者的身体拥有完全控制权。他们不会交换记忆，但实质上交换了心智，因此任何一方的角色都可以对自己施展法术来了解该角色过去的行动。唯一的限制是，这种交换不会影响任何一方的性格特征或决意点（如果召唤者拥有真实信仰 (True Faith)，还包括信仰点 (Faith Points)），并且召唤者也会带走他的感通特征。
...
迷魅是一种强大的持续效果，随着时间的推移会使召唤者遭受扭曲，在每个季节给他的身体带来 1 点扭曲点数，并且每年再增加 1 点。然而，由于召唤者的身体受妖精控制，而妖精受召唤者控制，只要交换还在持续，双方都免疫妖精感召 (Faerie Calling)。这是一条危险但有效的通往不朽的途径，也是一种让召唤者在不放弃其基本人性的情况下体验妖精域的引人入胜的方式。据说如果妖精在召唤者控制其身体期间死亡，这种交换就会变为永久性。然而，这一说法是否属实尚有待证明；其他人则担心，事实上妖精会回到自己的身体，而死亡的将是召唤者。大多数召唤者更倾向于确保居住在他们身体中的妖精在持续时间内保持安全且未受损伤。
...
研究过遣散技艺的召唤者有能力解除由拥有威能的存在所制造的超自然效果，并能将这些存在从束缚它们的其他效果中解救出来。要做到这一点，召唤者必须消耗一个疲劳等级，并且必须与相关存在进行交谈。与其他秘艺一样，他无法影响超过其感通特征允许范围的威能值或效果等级。

**Dismissing Total: stress die + Intelligence + Dismissing + Faerie Rank + aura**

**遣散总值：压力骰 + 智力 + 遣散 + 妖精等级 + 辉环**
...
- 召唤者可以取消任何由拥有威能值的存在的力量所产生的效果，前提是他的遣散总值超过该效果的等级，并且穿透该存在的魔法抗力。召唤者也可以在某个存在的力量生效之前将其偏转，前提是他能在一次机敏 + 纤技 (Quickness + Finesse) 压力检定中击败该存在的先攻总值。（如果召唤者拥有纤技技能，他可以将其最高适用的感通特征加到其分数上。）就像法师可以瞬发法术一样，召唤者也可以尝试在一轮内遣散多个效果，但每增加一个效果他就要承受累计 –6 的减值。
...
- 遣散可以结束任何以拥有威能值的存在为目标的效果的持续时间，前提是他穿透了该存在的魔法抗力，并且他的遣散总值超过被取消效果的等级。
...
- 召唤者可以将一个拥有威能值的存在从具有超自然效力的协议条款中释放出来，例如召唤者与妖精之间的议约。要做到这一点，召唤者的遣散总值必须超过该生物的威能值，并且必须穿透其魔法抗力。许多人认为，通过这个过程，召唤者自己承担了债务，从而使该存在免除了其义务。
...
在进行穿透检定时，如果该存在正被一个成功的召唤效果（如上所述，即穿透了其魔法抗力的效果）所持留，不要从穿透合计中减去效果等级。请注意，如果召唤者拥有适用的感通特征，他可以将其最高适用感通特征加到穿透合计中。
...
遣散是召唤者与妖精进行他无意遵守的议约，同时又不会遭受感通丧失的一种好方法。虽然这样做不会影响召唤者的妖精等级，但个别妖精很可能会对这种行为感到愤怒。为了避免惹怒它们，精明的召唤者总是会提供给妖精一些与原始议约条款价值相当的东西，以换取妖精接受对其使用这种力量。
...
神话欧洲中许多异教团体遵循着特定的妖精巫术传统，这使他们能够更轻松地学习该传统的偏好技能（见第五章：妖精之触，学习超自然技能）。妖精巫师还可以通过经历试炼 (Ordeals) 和遵循启蒙脚本 (Initiation Script) 来启入优势，就像其他树篱巫师所做的那样（详情请参阅《树篱魔法》(Hedge Magic)）。然而，妖精启蒙脚本很罕见，因为大多数巫师是从老师那里学习他们的力量。这里有三个这些团体的例子，以及他们特别擅长的技法和力量。
...
请注意，为了设计一个具有施行妖精仪式能力的初始角色，玩家必须将角色初始优势中的至少 4 点分配给一种妖精技法和一种妖精力量；而要实践妖精议约，角色必须拥有四种与奇幻技艺相关的优势之一，通常是召唤。任何一种角色都必须拥有感通特征，可以通过优势或劣势获得；由于他的力量受限于这些特征的数量，他可能需要好几个感通特征，或者一个很高的扭曲值，以便用经验将它们的数值提升到更高水平。
...
奇幻技艺 (Ars Fabulosa) 才刚刚开始在神话欧洲传播开来，在实践它们的人中，有一种自称为“妖精借用者 (faerie borrowers)”的奇特群体。这些人通常看起来格外具有异国情调——就像来自遥远国度、有着奇特生活习惯和非凡习俗的旅行者。他们可能会以商人或朝圣者、表演者或信使、甚至远方领主的士兵或间谍的身份出现。他们的主要兴趣在于妖精，他们特别擅长与妖精打交道，并且正是与妖精进行交易。他们基本上以向妖精域出售商品为生；他们的报酬是仙灵的赐福。当被问及他们借用了什么时，他们可能会回答说借用了妖精的力量——尽管他们中的一些人也会从人类那里“借用”，因为并非他们所有的货物都是通过正当途径获得的。
...
借用者通常经营新奇的商品；他们从遥远的地方收集奇怪的货物，包括小动物、食物和饮料、艺术精品，甚至是魔法器物（如附魔装置或其他含有源质的物品），这些商品通常能在妖精那里卖出好价钱，因为妖精通常相信来自遥远国度的宝物比当地获得的物品包含更多元气。通过谨慎谈判，借用者每年只需几次妖精交易，就能维持一项蓬勃发展的生意，只要他们的竞争对手仍然相对稀少。为了确保这一点，他们通常喜欢不断迁徙——他们说，这也能保持他们的存货新鲜。
...
为了协助交易，借用者偶尔会收有潜力的孩子为徒，通常是通过与妖精谈判，把那些被妖精认领或从父母那里偷走的孩子换出来。在利用学徒劳动力的同时，他们教导学徒如何议约以及与妖精打交道的复杂细节，并最终将他们启入奇幻技艺。最终他们会变得足够熟练，可以接管师傅的生意，或者自己独立门户。
...
**偏好技能 (Favored Abilities)：** 附魔、诱导、梦境、搬移
...
奥拉姆（Ollamhain，发音为“ah-luh-VAIN”）是爱尔兰的诗人、贤者和表演者，他们与美丽仙灵 (Fair Folk，他们对妖精的称呼) 有过许多交集，并声称与它们有着特殊的亲属关系。他们中的许多人拥有妖精血统 (Faerie Blood)。据说，他们古老的歌曲和诗歌如果以正确的风格表演就会蕴含魔法——这种力量能够洞察人心和思想、预见未来，甚至看透妖精域本身。为了这些表演，他们中的许多人偏爱具有象征意义、与他们及其岛屿相关联的爱尔兰竖琴，并从父传子地传承特殊的附魔乐器，这些乐器受到了能演奏得格外动听的赐福。
...
**偏好技能 (Favored Abilities)：** 唤灵、典仪、幻造、赋赐
...
在基督教东方分支触及不到的遥远地方，有些人从未听过福音，仍然保持着古老的异教习俗——他们就是被称为沃尔赫夫 (Volkhvy) 的俄罗斯妖精巫师。他们宏大的仪式堪称传奇，社区中的每个人都会聚集在一起，祈求他们的妖精神明援助，通常是通过反映他们所生活的严酷荒野的魅幻和赐福。由于这些极端的条件，他们通常拥有坚定的信念，变得格外自信；当然，这种优势既可能来自他们的妖精仪式，也可能来自他们个人的坚韧。
...
**偏好技能 (Favored Abilities)：** 移情、庇护、安康、灾厄
...
许多沾染妖精气息的男女通常生活在社会的边缘。陷入困境时向他们求助的村民称他们为“智者（wise men/wise women）”，但他们也因为自己怪异的生活方式和令人生畏的力量而被迫与社区分隔居住。他们的长处在于抵御超自然力量，并保护受其照料的人；通过自身奋力施为，他们可以治愈或伤害那些他们认为值得如此对待的人。赫尔墨斯秘会的法师们在使用“树篱巫师 (hedge wizard)”一词时，通常想象的就是这样的人。

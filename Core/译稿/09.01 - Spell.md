...
赫尔墨斯秘会收集并创造了数百种法术，它们数百年来被传授给学徒，并在法师之间交易流传。这里列出的法术代表了其中最有用、最有趣、最具示范性的部分；它们绝不是可用法术的完整清单，更多例子散见于各种补充资料，尤其是 *Magi of Hermes*。相反，你应将它们视为范例，以便发明自己的法术。其中许多法术都可以作为创造其他相似法术的良好范本。例如，一个把你变成狼的法术，可以作为把你变成另一种动物的法术模型。
...
法术等级衡量创造该法术效果所需的魔法力量。法术等级越高，法师剩余可用于突破魔法抗力的力量就越少。法术等级由法术效果准则决定的基础等级，加上距程、持续、目标和尺寸变化所带来的调整构成。
...
**声音：** 法师声音所能传到的任何事物。通常，坚定的说话声可传约15步，轻声可在5步内听见，喊叫可传约50步。以魔法增强声音不会增加此距程，而以此距程无声施展的法术只能影响施法者本人。声音距程的仪式和典仪法术距程约为50步，因为施法过程在某个阶段会包含响亮的声音。非人施法者，包括处于心兽形态的比约奈尔法师，其声音距程可能不同。不过，魔法变形属于对声音的魔法增强。距程取决于施法者声音能传多远，而不是目标是否能听见。聋哑目标、石头、嘈杂环境中的目标，以及受阻止声音抵达的 PeIm 法术影响的目标，都可以在正常距程内受到影响。不过，如果施法者被魔法消音或压低音量，距程会缩短。这类法术必须穿透施法者的魔法抗力。魔法物品使用持用者的声音；独立物品若要使用此距程，需要被赋予声音（CrIm）。距程在法术施展时确定，即使法师之后改变音量也保持不变。因此，声音距程法术可以允许无声控制，但只限于目标仍在法师施法时声音所能传到的距离之内。这给准则增加2量级。

**视线：** 法师能看见的任何事物。如果法师站在方圆数英里内的最高点，此距程可能极为辽阔。失明法师只能影响自己。魔法物品使用持用者的视线；独立物品若要使用此距程，需要能够看见（InIm）。这给准则增加3量级。
...
如同任何赫尔墨斯法术，防护必须穿透魔法抗力才能生效。像“Circular Ward Against Demons”这样的法术在高等级时更难施展，因为法术等级必须等于或超过任何受影响恶魔的威能数值 (Might Score)，而穿透合计也必须超过它。因此，法师很少学习或施展高于约30级的这类法术版本，而更偏好较低等级、能更直接阻碍目标行动的掌控法术。由于大多数情况下赫尔墨斯防护实际上并不以受其影响的生物为目标，多数法师不能用与超自然存在的奥法连接来增强穿透合计，除非该存在在防护施展时位于圆环之内。
...
范式或仪式法术可以被设计为允许施法者对产品作出某些改变，不过这通常会给法术等级增加量级，以反映复杂性。例如，*Conjuring the Mystic Tower* 允许施法者决定塔内房间布局。简单决定的难度等级为0，较复杂决定有更高难度等级。把神秘塔的每一层分成两半，难度等级为0；创造复杂迷宫则会有高得多的难度等级，可能为12。施法者只能改变法术设计允许改变的要素；例如，施法者不能改变神秘塔的高度或直径。
...
如果目标灵体位于神话欧洲，范式（或即兴）法术便足够。如果灵体在另一个界域中，例如秘法域、Arcadia、Purgatory 或 Hell，法术必须是仪式。（神圣律，也可能还有月界律，使 Heaven 处于不可触及之处。）就此而言，灵阶算作神话欧洲的一部分；还需注意，许多灵体，包括恶魔，大部分时间都待在神话欧洲。
...
技法和型式常以每个词的前两个字母缩写；因此 MuTe 法术属于万变技法与地型式。等级常加在缩写之后，例如 Flash of the Scarlet Flames 变为 CrIg 15。

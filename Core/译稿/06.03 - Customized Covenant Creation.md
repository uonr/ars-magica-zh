...
*结社*创建的基准是：一座能够容纳所有*法师*和其他*结社民*的石质建筑，位于 3 级*魔法辉环*中。*结社*没有魔法资源，但拥有足够的凡俗资源，确保*法师*无需为日常维护操心。每位*法师*约有一名*龙套*（战士），另有约两名其他*结社民*（如仆人和工匠）。可用工匠包括铁匠、木匠和也许有一名装订工，但更稀有的专家不在其中。*结社*虽难以进入，但在不使用魔法的情况下无法抵御正式的军事攻势。基础*结社*的老化修正值为 0。
...
*工坊文本*使*法师*能够比独自研究更快地完成魔法创作。迄今最常见的*工坊文本*是用于创制*范式法术*的文本，大多数*结社*图书馆中都存有大量此类文本。
...
每年提供*源质*的源质来源，是*结社*极为宝贵的资源。*源质*库存同样有用，大多数*结社*都力图储备一定数量以备不时之需。关于*原始源质*的更多信息见第 212 页，关于源质来源的信息见第 422 页。
